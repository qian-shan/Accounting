...
import com.example.Accounting.Chart;
import com.example.Accounting.CostBean;
import com.example.Accounting.CostListAdapter;
import com.example.Accounting.DataBaseHelper;
import com.example.Accounting.DividerItemDecoration;

import java.util.ArrayList;
import java.util.List;

import cn.itcast.test2.R;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter.setOnItemClickListener(new CostListAdapter.OnItemClickListener() {
            ...
            public void onItemLongClick(View view, int position) {
                ...
                intent.putExtra("detail",bean.costDetail);
        ...
        if(checkIntentAvailable(getIntent()))
        {
            ...
            if(i==1)
            {
                ...
                costBean.costDetail = chartdata.getStringExtra("beizhu");
...
//        }
        ...
        if(cursor != null)
        {
            ...
            while (cursor.moveToNext())
            {
                ...
                costBean.costDetail = cursor.getString(cursor.getColumnIndex("costDetail"));
        ...
        switch (requestCode){
            case 1:
                if(resultCode == RESULT_OK){
                    ...
                    costBean.costDetail = data.getStringExtra("beizhu");
