    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkIntentAvailable(getIntent()))
        {
            if(getIntent().getIntExtra("chart",0)==3)
            {
                ...
                et_beizhu.setText(getIntent().getStringExtra("detail"));
        ...
        btn_account_income.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_account_expend.setBackgroundColor(Color.parseColor("#00000000"));
            }
        });
        ...
        btn_account_expend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                btn_account_income.setBackgroundColor(Color.parseColor("#00000000"));
            }
        });
            ...
            public void onClick(View v) {
                ...
                if(j==0)
                {
                    ...
                    else
                    {
                        ...
                        intent.putExtra("beizhu",et_beizhu.getText().toString());
