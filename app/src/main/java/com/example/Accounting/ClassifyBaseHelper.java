...
public class ClassifyBaseHelper extends SQLiteOpenHelper {
    ...
    public void  insertCost(com.example.Accounting.CostClassify costClassify)
    {
    ...
    public  void upgradeCost(com.example.Accounting.CostClassify costClassify, String[] msg)
    {
        SQLiteDatabase database = getWritableDatabase();
        ContentValues cv = new ContentValues();
        cv.put("classifyName",costClassify.classifyName);
