...
public class CostListAdapter extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public final String TAG = "CostListAdapter";
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder,final int pos) {
        ...
        Log.i(TAG, "onBindViewHolder: 备注 = " + mList.get(pos).costDetail);
        Log.i(TAG, "onBindViewHolder: money = " + mList.get(pos).costMoney);

        holder.tv_date.setText(mList.get(pos).costDetail);
        holder.tv_cost.setText(mList.get(pos).costMoney);
        holder.textView.setText(mList.get(pos).costMonth + "-" +mList.get(pos).costDay);
